        ...
        */
        ...
        this.each(function() {
            ...
            $(targetElement).data("ui-autocomplete")._renderMenu = function(ul, items) {
                ...
                ul.append( '<li class="view-all"><a href="//qmul-search.clients.uk.funnelback.com/s/search.html?collection=queenmary-coursefinder-pg&query='+ this.term + '*">View all results for <strong>'+ this.term + '</strong></a></li>' );
            }
